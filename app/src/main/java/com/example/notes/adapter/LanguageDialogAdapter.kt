...
class LanguageDialogAdapter:RecyclerView.Adapter<LanguageDialogViewModel> {
    ...
    override fun onBindViewHolder(holder: LanguageDialogViewModel, position: Int) {
        ...
        holder.txtLanguage.setCompoundDrawablesWithIntrinsicBounds(listLanguage[position].drawableLanguage, 0, 0, 0)
        holder.txtLanguage.setOnClickListener {
            holder.txtLanguage.setCompoundDrawablesRelativeWithIntrinsicBounds(listLanguage[position].drawableLanguage, 0, R.drawable.ic_choose_tick, 0)
            i = position
